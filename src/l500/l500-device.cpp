...
namespace librealsense
{
        ...
        const std::vector<platform::uvc_device_info>& all_device_infos)
    {
        ...
        auto is_zo_enabled_opt_ptr = is_zo_enabled_opt.get();
        ...
        depth_ep->register_processing_block(
            ...
            [is_zo_enabled_opt_ptr]() {
                ...
                auto sync = std::make_shared<syncer_process_unit>(is_zo_enabled_opt_ptr);
                auto zo = std::make_shared<zero_order>(is_zo_enabled_opt_ptr);
