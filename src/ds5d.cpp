...
//        {
//            info.interstream_rules.push_back({ RS_STREAM_DEPTH, ir, &stream_profile::width, 0, 12, RS_STREAM_COUNT, false, false, false });
//            info.interstream_rules.push_back({ RS_STREAM_DEPTH, ir, &stream_profile::height, 0, 12, RS_STREAM_COUNT, false, false, false });
//            info.interstream_rules.push_back({ RS_STREAM_DEPTH, ir, &stream_profile::fps, 0, 0, RS_STREAM_COUNT, false, false, false });
//        }
//
//        info.interstream_rules.push_back({ RS_STREAM_INFRARED, RS_STREAM_INFRARED2, &stream_profile::fps, 0, 0, RS_STREAM_COUNT, false, false, false });
//        info.interstream_rules.push_back({ RS_STREAM_INFRARED, RS_STREAM_INFRARED2, &stream_profile::width, 0, 0, RS_STREAM_COUNT, false, false, false });
//        info.interstream_rules.push_back({ RS_STREAM_INFRARED, RS_STREAM_INFRARED2, &stream_profile::height, 0, 0, RS_STREAM_COUNT, false, false, false });
