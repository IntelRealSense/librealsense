...
/* Creates a usb_device_handle object for a USB device */
...
/* Creates a usb_device_handle object for already open USB device */
...
/* Resets a usb request to be reused */
struct usb_request *
usb_request_reset(struct usb_request *req, const struct usb_endpoint_descriptor *ep_desc);
/* Resets an endpoint*/
