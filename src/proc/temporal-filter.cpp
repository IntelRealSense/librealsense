...
{
    temporal_filter::temporal_filter(): _num_of_frames(5)
    {
        auto temporal_control = std::make_shared<ptr_option<uint8_t>>(1, 7, 1, 5, &_num_of_frames, "Temporal magnitude");
