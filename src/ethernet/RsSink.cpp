...
RsSink::RsSink(UsageEnvironment &t_env, MediaSubsession &t_subsession, rs2_video_stream t_stream, MemoryPool *t_memPool, char const *t_streamId)
    : MediaSink(t_env), m_memPool(t_memPool), m_subsession(t_subsession)
{
  m_stream = t_stream;
...
void RsSink::afterGettingFrameUid0(void *t_clientData, unsigned t_frameSize, unsigned t_numTruncatedBytes,
...
void RsSink::afterGettingFrameUid1(void *t_clientData, unsigned t_frameSize, unsigned t_numTruncatedBytes,
                                   struct timeval t_presentationTime, unsigned t_durationInMicroseconds)
{
...
void RsSink::afterGettingFrameUid2(void *t_clientData, unsigned t_frameSize, unsigned t_numTruncatedBytes,
                                   struct timeval t_presentationTime, unsigned t_durationInMicroseconds)
{
...
void RsSink::afterGettingFrameUid3(void *t_clientData, unsigned t_frameSize, unsigned t_numTruncatedBytes,
                                   struct timeval t_presentationTime, unsigned t_durationInMicroseconds)
{
...
Boolean RsSink::continuePlaying()
{
  ...
  {
    fSource->getNextFrame(m_receiveBuffer, m_bufferSize,
                          m_afterGettingFunctions.at(m_stream.uid), this,
