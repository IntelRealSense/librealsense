...
namespace librealsense
{
    ...
    public:
        ...
        fa_info(std::shared_ptr<context> ctx,
                 std::vector<platform::uvc_device_info> ir,
                 std::vector<platform::usb_device_info> hwm,
                 std::vector<platform::hid_device_info> hid)
            : device_info(ctx), _ir(std::move(ir)),
        ...
        {
            return platform::backend_device_group(_ir, _hwm, _hid);
        }
    private:
        std::vector<platform::uvc_device_info> _ir;
