...
namespace librealsense
{
        ...
        const std::vector<platform::uvc_device_info>& color_devices_info)
    {
        ...
        color_ep->register_metadata(RS2_FRAME_METADATA_AWB_TEMP, make_attribute_parser(&md_rgb_control::awb_temp, md_rgb_control_attributes::awb_temp_attribute, md_prop_offset));
        color_ep->register_metadata(RS2_FRAME_METADATA_BACKLIGHT_COMP, make_attribute_parser(&md_rgb_control::backlight_comp, md_rgb_control_attributes::backlight_comp_attribute, md_prop_offset));
        ...
        color_ep->register_metadata(RS2_FRAME_METADATA_MANUAL_WB, make_attribute_parser(&md_rgb_control::manual_wb, md_rgb_control_attributes::manual_wb_attribute, md_prop_offset));
        ...
        color_ep->register_metadata(RS2_FRAME_METADATA_LOW_LIGHT_COMP, make_attribute_parser(&md_rgb_control::low_light_comp, md_rgb_control_attributes::low_light_comp_attribute, md_prop_offset));
