...
#include <include/msgs/sensor_msgs/CameraInfo.h>
...
struct stream_info_
{
  ...
  typedef boost::shared_ptr< ::realsense_msgs::stream_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::realsense_msgs::stream_info_<ContainerAllocator> const> ConstPtr;

}; // struct stream_info_

typedef ::realsense_msgs::stream_info_<std::allocator<void> > stream_info;

typedef boost::shared_ptr< ::realsense_msgs::stream_info > stream_infoPtr;
typedef boost::shared_ptr< ::realsense_msgs::stream_info const> stream_infoConstPtr;
