...
struct frame_info_
{
  ...
  typedef boost::shared_ptr< ::realsense_msgs::frame_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::realsense_msgs::frame_info_<ContainerAllocator> const> ConstPtr;

}; // struct frame_info_

typedef ::realsense_msgs::frame_info_<std::allocator<void> > frame_info;

typedef boost::shared_ptr< ::realsense_msgs::frame_info > frame_infoPtr;
typedef boost::shared_ptr< ::realsense_msgs::frame_info const> frame_infoConstPtr;
