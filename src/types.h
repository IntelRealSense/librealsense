...
inline std::string sc_zone_type_to_string(rs2_safety_zone_type szt) {
    std::string result;
    switch (szt)
    {
...
inline std::string sc_mos_target_to_string(rs2_safety_mos_type mos) {
    std::string result;
    switch (mos)
    {
...
inline std::ostream& operator<<(std::ostream& out, rs2_safety_zone const sz)
{
    ...
    out << "\n\t\t" << "Minimum Object Size - Diameter: " << sz.miminum_object_size.x << " [mm]";
    out << "\n\t\t" << "Minimum Object Size - Length: " << sz.miminum_object_size.y << " [mm]";
    out << "\n\t\t" << "Minimum Object Size - Target Type: " << sc_mos_target_to_string(sz.mos_target_type);
    out << "\n\t\t" << "Reserved[16]: " << librealsense::array2str(sz.reserved);
    return out;
}

inline std::ostream& operator<<(std::ostream& out, rs2_safety_environment se)
{
    ...
    out << "\n\t\t" << "Reserved[16]: " << librealsense::array2str(se.reserved);
    return out;
}

inline std::ostream& operator<<(std::ostream& out, rs2_safety_extrinsics_table ext)
{
    out << "\t\t\t" << "Rotation:";
...
inline std::ostream& operator<<(std::ostream& out, rs2_safety_preset const& sp)
{
    ...
    out << "\n\t\t" << "Resereved[16]: " << librealsense::array2str(sp.platform_config.reserved);
    out << "\n\t" << "Safety Zone #0:" << "\n" << sp.safety_zones[0];
    out << "\n\t" << "Safety Zone #1:" << "\n" << sp.safety_zones[1];
    out << "\n\t" << "Safety Zone #2:" << "\n" << sp.safety_zones[2];
    out << "\n\t" << "Safety Zone #3:" << "\n" << sp.safety_zones[3];
