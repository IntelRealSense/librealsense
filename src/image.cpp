...
namespace librealsense
{
    ...
    int get_image_bpp(rs2_format format)
    {
        switch (format)
        {
        case RS2_FORMAT_DEPTH_CONFIDENCE: return 8;
...
#undef clamp
    ...
    const native_pixel_format pf_confidence_l500 = { 'C   ', 1, 1,{  { true,  &rotate_270_degrees_clockwise<1>,                    { { RS2_STREAM_CONFIDENCE_MAP, RS2_FORMAT_DEPTH_CONFIDENCE } } } } };
    const native_pixel_format pf_z16_l500        = { 'Z16 ', 1, 2,{  { true,  &rotate_270_degrees_clockwise<2>,                    { { RS2_STREAM_DEPTH,          RS2_FORMAT_Z16 } } } } };
    const native_pixel_format pf_y8_l500         = { 'GREY', 1, 1,{  { true,  &rotate_270_degrees_clockwise<1>,                    { { RS2_STREAM_INFRARED,       RS2_FORMAT_Y8 } } } } };
