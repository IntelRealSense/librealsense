...
namespace rsimpl
{
    ...
    const native_pixel_format pf_z16        = { 'Z16 ', 1, 2,{  { true,  &copy_pixels<2>,                   { { RS_STREAM_DEPTH,    RS_FORMAT_Z16 } } },
                                                                { true,  &copy_pixels<2>,                   { { RS_STREAM_DEPTH,    RS_FORMAT_DISPARITY16 } } } } };
    const native_pixel_format pf_invz       = { 'INVZ', 1, 2,{  { true,  &copy_pixels<2>,                   { { RS_STREAM_DEPTH,    RS_FORMAT_Z16 } } } } };
    const native_pixel_format pf_f200_invi  = { 'INVI', 1, 1,{  { true,  &copy_pixels<1>,                   { { RS_STREAM_INFRARED, RS_FORMAT_Y8 } } },
