...
namespace rsimpl
{
    ...
    const native_pixel_format pf_l8         = { 'GREY', 1, 1,{  { false, &copy_pixels<1>,                   { { RS_STREAM_INFRARED, RS_FORMAT_Y8  } } } } };
    ...
    const native_pixel_format pf_f200_invi  = { 'GREY', 1, 1, { { false, &copy_pixels<1>,                   { { RS_STREAM_INFRARED, RS_FORMAT_Y8  } } },
    ...
    const native_pixel_format pf_sr300_invi = { 'GREY', 1, 2,{  { true,  &unpack_y8_from_y16_10,            { { RS_STREAM_INFRARED, RS_FORMAT_Y8  } } },
    ...
    const native_pixel_format pf_yuyvl      = { 'YUYV', 1, 2,{  { true,  &unpack_yuy2<RS_FORMAT_RGB8 >,     { { RS_STREAM_INFRARED, RS_FORMAT_RGB8 } } },
                                                                { false, &copy_pixels<2>,                   { { RS_STREAM_INFRARED, RS_FORMAT_YUYV } } },
                                                                { true,  &unpack_yuy2<RS_FORMAT_RGBA8>,     { { RS_STREAM_INFRARED, RS_FORMAT_RGBA8} } },
                                                                { true,  &unpack_yuy2<RS_FORMAT_BGR8 >,     { { RS_STREAM_INFRARED, RS_FORMAT_BGR8 } } },
                                                                { true,  &unpack_yuy2<RS_FORMAT_BGRA8>,     { { RS_STREAM_INFRARED, RS_FORMAT_BGRA8} } } } };
