...
namespace librealsense
{
    ...
    public:
        ...
        virtual std::vector<uint8_t> run_on_chip_focal_length_calibration(int timeout_ms, std::string json, float* health, update_progress_callback_ptr progress_callback) = 0;
