...
void playback_sensor::register_calibration_change_callback( calibration_change_callback_ptr callback )
{
    throw librealsense::not_implemented_exception( "playback_sensor::register_calibration_change_callback" );
}
