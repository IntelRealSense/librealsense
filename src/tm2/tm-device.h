...
namespace librealsense
{
    ...
    private:
        ...
        perc::SIXDOF_MODE               _tm_mode = perc::SIXDOF_MODE_ENABLE_MAPPING | perc::SIXDOF_MODE_ENABLE_RELOCALIZATION | perc::SIXDOF_MODE_ENABLE_JUMPING;
        ...
        template <perc::SIXDOF_MODE flag, perc::SIXDOF_MODE depends_on> friend class tracking_mode_option;
    };
}
