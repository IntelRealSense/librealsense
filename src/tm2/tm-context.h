...
namespace librealsense
{
    ...
    public:
        ...
        std::vector<perc::TrackingDeviceHolder*> query_devices() const;
        signal<tm2_context, std::shared_ptr<tm2_info>, std::shared_ptr<tm2_info>> on_device_changed;
        // TrackingManager::Listener
        void onStateChanged(perc::TrackingManager::EventType state, perc::TrackingDeviceHolder* device) override;
        void onError(perc::Status error, perc::TrackingDeviceHolder*) override;
    private:
        void thread_proc();
        ...
        std::vector<perc::TrackingDeviceHolder*> _devices;
        context* _ctx;
