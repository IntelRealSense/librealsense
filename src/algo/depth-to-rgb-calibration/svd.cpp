...
static double b_xnrm2( int n, const double x[4], int ix0 )
{
    double y;
    double scale;
    int kend;
...
static double xnrm2( int n, const double x[12], int ix0 )
{
    double y;
    double scale;
    int kend;
...
static void b_xaxpy( int n, double a, const double x[12], int ix0, double y[3], int iy0 )
{
    int ix;
    int iy;
    int i1;
...
static void xaxpy( int n, double a, int ix0, double y[12], int iy0 )
{
    int ix;
    int iy;
    int i0;
...
static double xdotc( int n, const double x[12], int ix0, const double y[12], int iy0 )
{
    double d;
    int ix;
    int iy;
...
void svd( const double A[12], double U[3] )
{
    double b_A[12];
    double e[4];
    double work[3];
