...
void optimizer::deproject_sub_pixel(std::vector<double3>& points, const rs2_intrinsics_double& intrin, const double* x, const double* y, const uint16_t* depth, double depth_units)
{
