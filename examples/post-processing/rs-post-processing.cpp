...
int main(int argc, char * argv[]) try
{
    ...
    while (app)
    {
        ...
        {
            glViewport(static_cast<GLint>(0), static_cast<GLint>(h / 2), static_cast<GLsizei>(w / 2), static_cast<GLsizei>(h / 2));
            draw_pointcloud(w / 2, h / 2, original_view_orientation, original_points);
        }
        if (colored_filtered && filtered_points)
        {
            glViewport(static_cast<GLint>(w / 2), static_cast<GLint>(h / 2), static_cast<GLsizei>(w / 2), static_cast<GLsizei>(h / 2));
