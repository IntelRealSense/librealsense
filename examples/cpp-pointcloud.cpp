...
int main(int argc, char * argv[])
{
    ...
    while (!finished)
    {
        ...
        try{
            ...
            glfwInit();
            ostringstream ss; ss << "RealSense Point Cloud Example (" << dev.get_camera_info(RS2_CAMERA_INFO_DEVICE_NAME) << ")";
            ...
            bool rgb_rotation_btn = is_in(std::string(dev.get_camera_info(RS2_CAMERA_INFO_PRODUCT_ID)),
