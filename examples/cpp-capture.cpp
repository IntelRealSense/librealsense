...
int main(int argc, char * argv[]) try
{
    ...
    while(!glfwWindowShouldClose(win))
    {
        ...
        buffers[1].show(dev, align_depth_to_color ? (color_rectification_enabled ? rs::stream::depth_aligned_to_rectified_color : rs::stream::depth_aligned_to_color) : rs::stream::depth, w / 2, 0,
            w - w / 2, h / 2);
