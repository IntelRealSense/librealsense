...
#include <realdds/topics/ros2/std_msgs/msg/Header.h>
...
namespace std_msgs {
    namespace msg {
        ...
        const TypeObject* GetMinimalHeaderObject()
        {
            ...
            mst_stamp.common().member_type_id(*builtin_interfaces::msg::GetTimeIdentifier(false));
        ...
        const TypeObject* GetCompleteHeaderObject()
        {
            ...
            cst_stamp.common().member_type_id(*builtin_interfaces::msg::GetTimeIdentifier(true));
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("Two-integer timestamp that is expressed as seconds and nanoseconds.");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_stamp.detail().ann_custom().push_back(ann);
            }
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("Transform frame with which this data is associated.");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_frame_id.detail().ann_custom().push_back(ann);
            }
...

            {
                    ...
                    
                {
                    ...
                    AnnotationParameterValue paramValue;
                    paramValue._d(TK_NONE);
                    paramValue.from_string("Standard metadata for higher-level stamped data types.\nThis is generally used to communicate timestamped data\nin a particular coordinate frame.");
                    annParam.value(paramValue);
                    ann.param_seq().push_back(annParam);
                }
