        ...
        const TypeObject* GetCompleteTimeObject()
        {
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("The seconds component, valid over all int32 values.");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_sec.detail().ann_custom().push_back(ann);
            }
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("The nanoseconds component, valid in the range [0, 10e9).");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_nanosec.detail().ann_custom().push_back(ann);
            }
...

            {
                    ...
                    
                {
                    ...
                    AnnotationParameterValue paramValue;
                    paramValue._d(TK_NONE);
                    paramValue.from_string("This message communicates ROS Time defined here:\nhttps://design.ros2.org/articles/clock_and_time.html");
                    annParam.value(paramValue);
                    ann.param_seq().push_back(annParam);
                }
