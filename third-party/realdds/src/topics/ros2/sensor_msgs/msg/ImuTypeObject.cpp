...
void registerImuTypes()
{
    ...
    factory->add_type_object("sensor_msgs::msg::double__9", sensor_msgs::msg::Getdouble__9Identifier(true),
            sensor_msgs::msg::Getdouble__9Object(true));
    factory->add_type_object("sensor_msgs::msg::double__9", sensor_msgs::msg::Getdouble__9Identifier(false),
            sensor_msgs::msg::Getdouble__9Object(false));
...
namespace sensor_msgs {
    namespace msg {
        const TypeIdentifier* Getdouble__9Identifier(bool complete)
        {
            const TypeIdentifier* c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("double__9", complete);
            if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
            {
                return c_identifier;
            }

            Getdouble__9Object(complete); // Generated inside
            return TypeObjectFactory::get_instance()->get_type_identifier("double__9", complete);
        }

        const TypeObject* Getdouble__9Object(bool complete)
        {
            const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("double__9", complete);
            ...
            {
                return GetCompletedouble__9Object();
            }
            else
            {
        ...
        const TypeObject* GetMinimaldouble__9Object()
        {
            const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("double__9", false);
            if (c_type_object != nullptr)
            {
                return c_type_object;
            }
            ...
            TypeObjectFactory::get_instance()->add_alias("double__9", TypeNamesGenerator::get_array_type_name("double", {9}));

            TypeObjectFactory::get_instance()->add_type_object("double__9", &identifier, type_object);
            delete type_object;
            return TypeObjectFactory::get_instance()->get_type_object("double__9", false);
        }

        const TypeObject* GetCompletedouble__9Object()
        {
            const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("double__9", true);
            ...
            type_object->complete().alias_type().header().detail().type_name("double__9");
            ...
            TypeObjectFactory::get_instance()->add_type_object("double__9", &identifier, type_object);
            delete type_object;
            return TypeObjectFactory::get_instance()->get_type_object("double__9", true);
        }
        ...
        const TypeObject* GetMinimalImuObject()
        {
            ...
            mst_orientation_covariance.common().member_type_id(*sensor_msgs::msg::Getdouble__9Identifier(false));
            ...
            mst_angular_velocity_covariance.common().member_type_id(*sensor_msgs::msg::Getdouble__9Identifier(false));
            ...
            mst_linear_acceleration_covariance.common().member_type_id(*sensor_msgs::msg::Getdouble__9Identifier(false));
        ...
        const TypeObject* GetCompleteImuObject()
        {
            ...
            cst_orientation_covariance.common().member_type_id(*sensor_msgs::msg::Getdouble__9Identifier(true));
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("Row major about x, y, z axes");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_orientation_covariance.detail().ann_custom().push_back(ann);
            }
            ...
            cst_angular_velocity_covariance.common().member_type_id(*sensor_msgs::msg::Getdouble__9Identifier(true));
...

            {
                ...
                cst_angular_velocity_covariance.detail().ann_custom().push_back(ann);
            }
            ...
            cst_linear_acceleration_covariance.common().member_type_id(*sensor_msgs::msg::Getdouble__9Identifier(true));
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("Row major x, y z");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_linear_acceleration_covariance.detail().ann_custom().push_back(ann);
            }
