    ...
    namespace msg {
        ...
        const TypeObject* GetCompleteImageObject()
        {
...

            {
                ...
                //ann.annotation_typeid(GetverbatimIdentifier(true));
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    {
                        AppliedAnnotationParameter annParam;
                        MD5 message_hash("language");
                        for(int i = 0; i < 4; ++i)
                        {
                            annParam.paramname_hash()[i] = message_hash.digest[i];
                        }
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("comment");
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("Header timestamp should be acquisition time of image\nHeader frame_id should be optical frame of camera\norigin of frame should be optical center of cameara\n+x should point to the right in the image\n+y should point down in the image\n+z should point into to plane of the image\nIf the frame_id here and the frame_id of the CameraInfo\nmessage associated with the image conflict\nthe behavior is undefined");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_header.detail().ann_custom().push_back(ann);
            }
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("image height, that is, number of rows");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_height.detail().ann_custom().push_back(ann);
            }
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("image width, that is, number of columns");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_width.detail().ann_custom().push_back(ann);
            }
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("The legal values for encoding are in file src/image_encodings.cpp\nIf you want to standardize a new string format, join\nros-users@lists.ros.org and send an email proposing a new encoding.\nEncoding of pixels -- channel meaning, ordering, size\ntaken from the list of strings in include/sensor_msgs/image_encodings.hpp");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_encoding.detail().ann_custom().push_back(ann);
            }
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("is this data bigendian?");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_is_bigendian.detail().ann_custom().push_back(ann);
            }
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("Full row length in bytes");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_step.detail().ann_custom().push_back(ann);
            }
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("actual matrix data, size is (step * rows)");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_data.detail().ann_custom().push_back(ann);
            }
...

            {
                    ...
                    
                {
                    ...
                    AnnotationParameterValue paramValue;
                    paramValue._d(TK_NONE);
                    paramValue.from_string("This message contains an uncompressed image\n(0, 0) is at top-left corner of image");
                    annParam.value(paramValue);
                    ann.param_seq().push_back(annParam);
                }
