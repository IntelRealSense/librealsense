...
bool set_parameters_response_msg::take_next( dds_topic_reader & reader, dds_sample * sample )
{
    dds_sample sample_;
    if( ! sample )
...
dds_sequence_number set_parameters_response_msg::respond_to( dds_sample const & request_sample,
