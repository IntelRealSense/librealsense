...
#include <realdds/topics/ros2/geometry_msgs/msg/Quaternion.h>
#include "QuaternionTypeObject.h"
#include <utility>
#include <sstream>
    ...
    namespace msg {
        ...
        const TypeObject* GetCompleteQuaternionObject()
        {
...

            {
                ...
                cst_y.detail().ann_custom().push_back(ann);
            }
...

            {
                ...
                cst_z.detail().ann_custom().push_back(ann);
            }
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("default"));
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d();
                        paramValue.from_string("1.0");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_w.detail().ann_custom().push_back(ann);
            }
...

            {
                    ...
                    
                {
                    ...
                    AnnotationParameterValue paramValue;
                    paramValue._d(TK_NONE);
                    paramValue.from_string("This represents an orientation in free space in quaternion form.");
                    annParam.value(paramValue);
                    ann.param_seq().push_back(annParam);
                }
