...
#include <realdds/topics/ros2/geometry_msgs/msg/Vector3.h>
#include "Vector3TypeObject.h"
#include <utility>
#include <sstream>
        ...
        const TypeObject* GetCompleteVector3Object()
        {
...

            {
                ...
                ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("verbatim"));
                    ...
                    
                    {
                        ...
                        AnnotationParameterValue paramValue;
                        paramValue._d(TK_NONE);
                        paramValue.from_string("This is semantically different than a point.\nA vector is always anchored at the origin.\nWhen a transform is applied to a vector, only the rotational component is applied.");
                        annParam.value(paramValue);
                        ann.param_seq().push_back(annParam);
                    }
                    
                cst_x.detail().ann_custom().push_back(ann);
            }
...

            {
                    ...
                    
                {
                    ...
                    AnnotationParameterValue paramValue;
                    paramValue._d(TK_NONE);
                    paramValue.from_string("This represents a vector in free space.");
                    annParam.value(paramValue);
                    ann.param_seq().push_back(annParam);
                }
