...
namespace perc {
    ...
    Status Device::GetSupportedProfile(TrackingData::Profile& profile)
    {
        ...
        {
            sixDofProfile.set(false, SIXDOF_MODE_ENABLE_MAPPING | SIXDOF_MODE_ENABLE_RELOCALIZATION | SIXDOF_MODE_ENABLE_JUMPING, SIXDOF_INTERRUPT_RATE::SIXDOF_INTERRUPT_RATE_IMU, (SixDofProfileType)i);
