...
#define ILLEGAL_HANDLE (-1)
    ...
    */
    typedef enum {
        ...
        SIXDOF_MODE_ENABLE_JUMPING = 0x0008,
        SIXDOF_MODE_MAX = ((SIXDOF_MODE_FAST_PLAYBACK | SIXDOF_MODE_ENABLE_MAPPING | SIXDOF_MODE_ENABLE_RELOCALIZATION | SIXDOF_MODE_ENABLE_JUMPING) + 1)
    } SIXDOF_MODE;
