...
// Copyright(c) 2020-5 RealSense, Inc. All Rights Reserved.
#pragma once
...
public:
    ...
    void reset( clock::time_point start_time = clock::now() ) { _start = start_time; }
    ...
    clock::duration get_elapsed() const { return clock::now() - _start; }

    // Get stopwatch start time
    clock::time_point get_start() const { return _start; }
