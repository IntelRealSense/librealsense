...
struct pose_
{
  ...
  typedef std::shared_ptr< ::realsense_msgs::pose_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::realsense_msgs::pose_<ContainerAllocator> const> ConstPtr;

}; // struct pose_

typedef ::realsense_msgs::pose_<std::allocator<void> > pose;

typedef std::shared_ptr< ::realsense_msgs::pose > posePtr;
typedef std::shared_ptr< ::realsense_msgs::pose const> poseConstPtr;
