...
namespace rs2
{
    ...
    void stream_model::add_d500_metadata_descriptions(std::map<rs2_frame_metadata_value, std::string>& descriptions) const
    {
        ...
        descriptions[RS2_FRAME_METADATA_SAFETY_OPERATIONAL_MODE] = "Bitmask, enumerated";
        ...
        descriptions[RS2_FRAME_METADATA_SAFETY_PRESET_ID_SELECTED] = "Bitmask, enumerated";
        descriptions[RS2_FRAME_METADATA_SAFETY_PRESET_ID_USED] = "Bitmask, enumerated";
        ...
        descriptions[RS2_FRAME_METADATA_SAFETY_MB_FUSA_EVENT] = "";
        descriptions[RS2_FRAME_METADATA_SAFETY_MB_FUSA_ACTION] = "";
        descriptions[RS2_FRAME_METADATA_SAFETY_MB_STATUS] = "";
        descriptions[RS2_FRAME_METADATA_SAFETY_SMCU_STATUS] = "";
        descriptions[RS2_FRAME_METADATA_SAFETY_SMCU_STATE] = "";
