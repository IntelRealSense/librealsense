...
inline void draw_advanced_mode_controls(rs400::advanced_mode& advanced, advanced_mode_control& amc, bool& get_curr_advanced_controls)
{
    if (get_curr_advanced_controls)
    {
        ...
        amc.hdad.vals[1] = amc.hdad.vals[0]; //setting min/max to the samve value
        amc.hdad.vals[2] = amc.hdad.vals[0]; //setting min/max to the samve value
        amc.ae.vals[0] = advanced.get_ae_control();
        amc.ae.vals[1] = amc.ae.vals[0]; //setting min/max to the samve value
        amc.ae.vals[2] = amc.ae.vals[0]; //setting min/max to the samve value
