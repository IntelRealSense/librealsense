...
namespace rs2
{
    ...
    void prepare_config_file()
    {
        ...
        config_file::instance().set_default(configurations::window::font_size_delta, 0 );
    ...
    void ux_window::open_window()
    {
        ...
        imgui_easy_theming(_font_14, _font_18, _monofont, font_size_delta);
    ...
    ux_window::ux_window(const char* title, context &ctx) :
        ...
        _font_14(nullptr), _font_18(nullptr), _monofont(nullptr), font_size_delta(0), _app_ready(false),
