...
1. Ensure apt-get is up to date
  ...
  * **Note:** Or `sudo apt-get distr-upgrade` in case you have an older ubuntu 14.04 version (with deprecated nvidia-331), as this prevents the linux 4.4 kernel to compile properly.
