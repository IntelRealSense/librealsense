# RealSense&trade; D400 cameras with Raspberry Pi

This document describes how to use the RealSense D400 cameras on Raspberry PI 3 Model B (which offers only USB2 interface).
...
2. Clone and compile the latest [RealSense&trade; SDK 2.0](https://github.com/IntelRealSense/librealsense/releases/latest) by following the instructions under [Linux Installation](https://github.com/IntelRealSense/librealsense/blob/development/doc/installation.md).
...
## Expected Output
1. Streaming Depth data with 480x270 resolution and 30 FPS using the [RealSense Viewer](https://github.com/IntelRealSense/librealsense/tree/master/tools/realsense-viewer).
