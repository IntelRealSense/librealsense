...
namespace librealsense
{
    ...
    void generic_ds5_active_full_super_dense_depth(preset& p)
    {
        ...
        p.rsm.diffThresh = 1.036730051041;
        p.rsm.removeThresh = 127;
        p.rsm.rsmBypass = 0;
        p.rsm.sloRauDiffThresh = 0.8955339789391;
        p.rsvc.minEast = 7;
        p.rsvc.minNorth = 1;
        p.rsvc.minNSsum = 7;
        p.rsvc.minSouth = 3;
    ...
    void generic_ds5_active_vga_generic_depth(preset& p)
    {
        ...
        p.depth_controls.textureCountThreshold = 0;
        p.rsm.diffThresh = 3.80778002739;
        p.rsm.removeThresh = 93;
        p.rsm.rsmBypass = 0;
        p.rsm.sloRauDiffThresh = 0.4221659898758;
        p.rsvc.minEast = 3;
        p.rsvc.minNorth = 1;
        p.rsvc.minNSsum = 4;
        p.rsvc.minSouth = 3;
    ...
    void generic_ds5_active_vga_dense_depth(preset& p)
    {
        ...
        p.rsm.diffThresh = 4.996399879456;
    ...
    void generic_ds5_active_vga_accurate_depth(preset& p)
    {
        ...
        p.depth_controls.scoreThreshB = 2047;
        p.depth_controls.textureCountThreshold = 0;
        p.rsm.diffThresh = 3.517060041428;
    ...
    void generic_ds5_active_small_dense_depth(preset& p)
    {
        ...
        p.depth_controls.textureCountThreshold = 0;
        p.rsm.diffThresh = 4.707439899445;
        p.rsm.removeThresh = 53;
        p.rsm.rsmBypass = 0;
        p.rsm.sloRauDiffThresh = 0.007420899812132;
        p.rsvc.minEast = 6;
        p.rsvc.minNorth = 1;
        p.rsvc.minNSsum = 1;
        p.rsvc.minSouth = 1;
    ...
    void specific_ds5_passive_full_hand_gesture(preset& p)
    {
        ...
        p.rsm.removeThresh = 93;
        p.rsm.rsmBypass = 0;
        p.rsm.sloRauDiffThresh = 0.4557830095291;
        p.rsvc.minEast = 3;
        p.rsvc.minNorth = 1;
        p.rsvc.minNSsum = 4;
        p.rsvc.minSouth = 3;
