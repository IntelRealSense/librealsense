...
TEST_CASE("Weights calc", "[d2rgb]")
{
    ...
    for (auto dir : data_dirs)
    {
        ...
        CHECK(compare_to_bin_file< double >(ir_data.valid_location_rc_x, dir, scene, FILE_NAME("gridXValid", 1, 105794, "double_00").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.valid_location_rc_y, dir, scene, FILE_NAME("gridYValid", 1, 105794, "double_00").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.valid_location_rc, dir, scene, FILE_NAME("locRC", 2, 105794, "double_00").c_str(), 105794, 2, compare_same_vectors));// it passed, depends on index definition
        ...
        CHECK(compare_to_bin_file< double >(ir_data.direction_per_pixel, dir, scene, FILE_NAME("dirPerPixel", 2, 105794, "double_00").c_str(), 105794, 2, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region[0], dir, scene, FILE_NAME("localRegion", 2, 105794, "double_00").c_str(), 105794, 2, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region[1], dir, scene, FILE_NAME("localRegion", 2, 105794, "double_01").c_str(), 105794, 2, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region[2], dir, scene, FILE_NAME("localRegion", 2, 105794, "double_02").c_str(), 105794, 2, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region[3], dir, scene, FILE_NAME("localRegion", 2, 105794, "double_03").c_str(), 105794, 2, compare_same_vectors));// it passed, depends on index definition

        CHECK(compare_to_bin_file< double >(ir_data.local_region_x[0], dir, scene, FILE_NAME("localRegion_x", 1, 105794, "double_00").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region_x[1], dir, scene, FILE_NAME("localRegion_x", 1, 105794, "double_01").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region_x[2], dir, scene, FILE_NAME("localRegion_x", 1, 105794, "double_02").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region_x[3], dir, scene, FILE_NAME("localRegion_x", 1, 105794, "double_03").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition

        CHECK(compare_to_bin_file< double >(ir_data.local_region_y[0], dir, scene, FILE_NAME("localRegion_y", 1, 105794, "double_00").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region_y[1], dir, scene, FILE_NAME("localRegion_y", 1, 105794, "double_01").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region_y[2], dir, scene, FILE_NAME("localRegion_y", 1, 105794, "double_02").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition
        CHECK(compare_to_bin_file< double >(ir_data.local_region_y[3], dir, scene, FILE_NAME("localRegion_y", 1, 105794, "double_03").c_str(), 105794, 1, compare_same_vectors));// it passed, depends on index definition
