...
//#cmake:custom-main
and define CATCH_CONFIG_RUNNER before including catch.h/catch.hpp so that catch2 doesn't define it's
own main.
*/
...
int main( int argc, char * argv[] )
{
    ...
    auto cli = session.cli()
             | Opt( test_context, "context" )["--context"]( "Context in which to run the tests" );
