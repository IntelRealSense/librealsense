...
//bool compare_extrinsic(const rs2_extrinsics& first, const rs2_extrinsics& second, double delta = 0)
//{
//    for (auto i = 0; i < 9; i++)
//    {
//        REQUIRE(first.rotation[i] == Approx(second.rotation[i]));
//    }
//    for (auto i = 0; i < 3; i++)
//    {
//        REQUIRE(first.translation[i] == Approx(second.translation[i]));
