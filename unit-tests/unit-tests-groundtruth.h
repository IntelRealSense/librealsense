...
namespace librealsense
{
    ...
    inline std::unordered_set<stream_profile> generate_device_profiles(std::string pid)
    {
        using namespace ds;
    ...
    //std::vector<rs2_frame_metadata_value> generate_device_metadata(uint16_t pid)
    //{
    //    switch (pid)
    //    {
    //    case L500_PID:
    ...
    //std::vector<rs2_frame_metadata_value> generate_device_metadata(std::string pid)
    //{
    //    using namespace librealsense;
    //    PID_t pid_num = string_to_hex(pid);
