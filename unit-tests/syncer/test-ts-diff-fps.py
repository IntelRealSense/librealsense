...
sw.generate_depth_frame(4, sw.gap_d * 4)
sw.expect(depth_frame=4)
sw.generate_depth_frame(5, sw.gap_d * 5)
sw.expect(depth_frame=5)
sw.generate_depth_frame(6, sw.gap_d * 6)
sw.expect(depth_frame=6)
sw.generate_depth_frame(7, sw.gap_d * 7)
sw.expect(depth_frame=7)
sw.generate_depth_frame(8, sw.gap_d * 8)
sw.expect(depth_frame=8)
sw.generate_depth_frame(9, sw.gap_d * 9)
...
#
sw.generate_depth_frame(13, sw.gap_d * 13)
sw.expect(depth_frame=13)
sw.generate_depth_frame(14, sw.gap_d * 14)
sw.expect(depth_frame=14)
sw.generate_depth_frame(15, sw.gap_d * 15)
sw.expect(depth_frame=15)
sw.generate_depth_frame(16, sw.gap_d * 16)
sw.expect(depth_frame=16)
sw.generate_depth_frame(17, sw.gap_d * 17)
sw.expect(depth_frame=17)
