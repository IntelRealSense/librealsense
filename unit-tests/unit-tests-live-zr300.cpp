...
//        std::vector<unsigned int> frame_drop_bins;
//        frame_drop_bins.reserve(100);      // We're interested to check difference between two consecutive frame up to 100 frames distance
//        // Frame drops statistics validaton
//        for (size_t i = 1; i < (gyro_frames.size()); i++)
//        {
//            frame_drop_bins.
//        }
