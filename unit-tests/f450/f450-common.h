...
void checkOption(rs2::sensor sensor, rs2_option option, float initialValue, float limitValue, int number_of_iterations, float tolerance,
...
void checkOptionForBothSensors(rs2::sensor sensor, rs2_option option, rs2_option option_second, float initialValue, float limitValue, int number_of_iterations, float tolerance,
    loop_condition_callback lc_cb, value_change_callback vc_cb, value_validation_callback vv_cb)
{
    float valueAfterChange = initialValue;
