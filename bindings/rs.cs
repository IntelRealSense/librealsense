...
namespace RealSense
{
    ...
    public enum Stream : int
    {
        ...
        DepthAlignedToColor = 7, // Synthetic stream containing depth data but sharing intrinsics of color stream
        DepthAlignedToRectifiedColor = 8 // Synthetic stream containing depth data but sharing intrinsics of rectified color stream
    }
