...
namespace RealSense
{
    ...
    public enum Stream : int
    {
        ...
        RectifiedColor = 5, // Synthetic stream containing undistorted color data with no extrinsic rotation from the depth stream
        ColorAlignedToDepth = 6, // Synthetic stream containing color data but sharing intrinsics of depth stream
        Infrared2AlignedToDepth = 7, // Synthetic stream containing second viewpoint infrared data but sharing intrinsics of depth stream
        DepthAlignedToColor = 8, // Synthetic stream containing depth data but sharing intrinsics of color stream
        DepthAlignedToRectifiedColor = 9, // Synthetic stream containing depth data but sharing intrinsics of rectified color stream
        DepthAlignedToInfrared2 = 10 // Synthetic stream containing depth data but sharing intrinsics of second viewpoint infrared stream
    }
