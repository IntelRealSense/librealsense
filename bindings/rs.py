...
STREAM_INFRARED2_ALIGNED_TO_DEPTH       = 7   ##< Synthetic stream containing second viewpoint infrared data but sharing intrinsics of depth stream
STREAM_DEPTH_ALIGNED_TO_COLOR           = 8   ##< Synthetic stream containing depth data but sharing intrinsics of color stream
STREAM_DEPTH_ALIGNED_TO_RECTIFIED_COLOR = 9   ##< Synthetic stream containing depth data but sharing intrinsics of rectified color stream
STREAM_DEPTH_ALIGNED_TO_INFRARED2       = 10  ##< Synthetic stream containing depth data but sharing intrinsics of second viewpoint infrared stream
STREAM_COUNT                            = 11 
