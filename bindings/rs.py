...
FORMAT_XYZ32F      = 2   ##< 32 bit floating point 3D coordinates. The depth in meters is equal to the Z coordinate
FORMAT_DISPARITY16 = 3   ##< 16 bit linear disparity values. The depth in meters is equal to depth scale / pixel value
FORMAT_YUYV        = 4  
FORMAT_RGB8        = 5  
FORMAT_BGR8        = 6  
FORMAT_RGBA8       = 7  
...
OPTION_COLOR_CONTRAST                  = 2   ##< Controls contrast of color image. Setting any value will disable auto contrast.
...
OPTION_COLOR_ENABLE_AUTO_CONTRAST      = 10  ##< Set to 1 to enable automatic contrast control, or 0 to return to manual control
OPTION_COLOR_ENABLE_AUTO_EXPOSURE      = 11  ##< Set to 1 to enable automatic exposure control, or 0 to return to manual control
OPTION_COLOR_ENABLE_AUTO_HUE           = 12  ##< Set to 1 to enable automatic hue control, or 0 to return to manual control
OPTION_COLOR_ENABLE_AUTO_WHITE_BALANCE = 13  ##< Set to 1 to enable automatic white balance control, or 0 to return to manual control
OPTION_F200_LASER_POWER                = 14  ##< 0 - 15
OPTION_F200_ACCURACY                   = 15  ##< 0 - 3
OPTION_F200_MOTION_RANGE               = 16  ##< 0 - 100
OPTION_F200_FILTER_OPTION              = 17  ##< 0 - 7
OPTION_F200_CONFIDENCE_THRESHOLD       = 18  ##< 0 - 15
OPTION_F200_DYNAMIC_FPS                = 19  ##< {2, 5, 15, 30, 60}
OPTION_R200_LR_AUTO_EXPOSURE_ENABLED   = 20  ##< {0, 1}
OPTION_R200_LR_GAIN                    = 21  ##< 100 - 1600 (Units of 0.01)
OPTION_R200_LR_EXPOSURE                = 22  ##< > 0 (Units of 0.1 ms)
OPTION_R200_EMITTER_ENABLED            = 23  ##< {0, 1}
OPTION_R200_DEPTH_CONTROL_PRESET       = 24  ##< 0 - 5, 0 is default, 1-5 is low to high outlier rejection
OPTION_R200_DEPTH_UNITS                = 25  ##< micrometers per increment in integer depth values, 1000 is default (mm scale)
OPTION_R200_DEPTH_CLAMP_MIN            = 26  ##< 0 - USHORT_MAX
OPTION_R200_DEPTH_CLAMP_MAX            = 27  ##< 0 - USHORT_MAX
OPTION_R200_DISPARITY_MULTIPLIER       = 28  ##< 0 - 1000, the increments in integer disparity values corresponding to one pixel of disparity
OPTION_R200_DISPARITY_SHIFT            = 29 
OPTION_COUNT                           = 30 
