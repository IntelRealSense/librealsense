...
function rs2_camera_info_to_string(info: Trs2_camera_info): PChar;
...
function rs2_stream_to_string(stream: Trs2_stream): PChar;
  cdecl; external REALSENSE_DLL;
...
function rs2_format_to_string(format: Trs2_format): PChar; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_sensors_count(info_list: pRS2_sensor; error: pRS2_error): integer;
  cdecl; external REALSENSE_DLL;
...
function rs2_create_device_from_sensor(sensor: pRS2_sensor;
...
function rs2_get_stereo_baseline(sensor: pRS2_sensor; error: pRS2_error): single;
  cdecl; external REALSENSE_DLL;
{
...
procedure rs2_open_multiple(device: pRS2_sensor; const profiles: pRS2_stream_profile;
  Count: integer; erroro: pRS2_error); cdecl; external REALSENSE_DLL;
{
...
procedure rs2_set_notifications_callback(sensor: pRS2_sensor;
  on_notification: pRS2_notification_callback_ptr; user: pvoid; error: pRS2_error);
  cdecl; external REALSENSE_DLL;
{
...
function rs2_get_stream_profiles(sensor: pRS2_sensor;
  error: pRS2_error): prs2_stream_profile_list; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_debug_stream_profiles(sensor: pRS2_sensor;
  error: pRS2_error): prs2_stream_profile_list; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_active_streams(sensor: pRS2_sensor;
  error: pRS2_error): prs2_stream_profile_list; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_stream_profile(const list: pRS2_stream_profile;
  index: integer; error: pRS2_error): pRS2_stream_profile; cdecl; external REALSENSE_DLL;
{
...
function rs2_clone_stream_profile(const mode: pRS2_stream_profile;
  stream: Trs2_stream; index: integer; format: Trs2_format;
...
function rs2_clone_video_stream_profile(const mode: pRS2_stream_profile;
  ...
  Height: integer; const intr: pRS2_intrinsics; error: pRS2_error): pRS2_stream_profile;
  cdecl; external REALSENSE_DLL;
{
...
procedure rs2_get_video_stream_resolution(const mode: pRS2_stream_profile;
  Width: PInteger; Height: PInteger; error: pRS2_error); cdecl; external REALSENSE_DLL;
{
...
procedure rs2_get_extrinsics(const afrom: pRS2_stream_profile;
  ato: pRS2_stream_profile; extrin: pRS2_extrinsics; error: pRS2_error);
  cdecl; external REALSENSE_DLL;
{
param[in] from          origin stream profile
param[in] to            target stream profile
...
procedure rs2_override_extrinsics(const sensor: pRS2_sensor;
  const extrinsics: pRS2_extrinsics; error: pRS2_error); cdecl; external REALSENSE_DLL;
{
...
function rs2_get_recommended_processing_blocks_count(const list: pRS2_processing_block;
  error: pRS2_error): integer; cdecl; external REALSENSE_DLL;
{
...
function rs2_export_localization_map(sensor: pRS2_sensor;
...
function rs2_set_static_node(const sensor: pRS2_sensor; guid: PChar;
  const pos: Trs2_vector; const orient: Trs2_quaternion; error: pRS2_error): integer;
  cdecl; external REALSENSE_DLL;
{
...
procedure rs2_set_intrinsics(const sensor: pRS2_sensor;
  const profile: pRS2_stream_profile; intrinsics: pRS2_intrinsics; error: pRS2_error);
  cdecl; external REALSENSE_DLL;
{
...
procedure rs2_override_intrinsics(const sensor: pRS2_sensor;
  const extrinsics: pRS2_extrinsics; error: pRS2_error); cdecl; external
  REALSENSE_DLL;
{
...
procedure rs2_reset_sensor_calibration(const sensor: pRS2_sensor; error: pRS2_error);
  cdecl; external REALSENSE_DLL;
{
...
function rs2_get_max_usable_depth_range(sensor: pRS2_sensor; error: pRS2_error): single;
  cdecl; external REALSENSE_DLL;
