...
function rs2_pipeline_poll_for_frames(pipe: pRS2_pipeline; out_frame: pRS2_frame;
...
function rs2_pipeline_start(pipe: pRS2_pipeline;
  error: pRS2_pipeline): pRS2_pipeline_profile; cdecl; external REALSENSE_DLL;
{
    Start the pipeline streaming with its default configuration.
...
function rs2_pipeline_start_with_callback(pipe: pRS2_pipeline;
  on_frame: pRS2_frame_callback_ptr; user: pvoid;
  error: pRS2_error): pRS2_pipeline_profile;
  cdecl; external REALSENSE_DLL;
{
    Start the pipeline streaming according to the configuraion.
    The pipeline captures samples from the device, and delivers them to the through the provided frame callback.
...
function rs2_pipeline_get_active_profile(pipe: pRS2_pipeline;
  error: pRS2_error): pRS2_pipeline_profile; cdecl; external REALSENSE_DLL;
{
