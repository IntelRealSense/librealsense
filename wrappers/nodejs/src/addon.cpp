...
void InitModule(v8::Local<v8::Object> exports) {
  ...
  _FORCE_SET_ENUM(RS2_OPTION_SAFETY_MODE);
  ...
  // rs2_safety_mode
  _FORCE_SET_ENUM(RS2_SAFETY_MODE_RUN)
  _FORCE_SET_ENUM(RS2_SAFETY_MODE_STANDBY)
  _FORCE_SET_ENUM(RS2_SAFETY_MODE_SERVICE)
  _FORCE_SET_ENUM(RS2_SAFETY_MODE_COUNT)
}
