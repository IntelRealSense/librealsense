...
void InitModule(v8::Local<v8::Object> exports) {
  ...
  _FORCE_SET_ENUM(RS2_STREAM_SAFETY);
  ...
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_DEPTH_FRAME_COUNTER);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_LEVEL1);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_LEVEL1_ORIGIN);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_LEVEL2);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_LEVEL2_ORIGIN);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_LEVEL1_VERDICT);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_LEVEL2_VERDICT);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_HUMAN_VOTE_RESULT);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_HARA_EVENTS);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_SOC_FUSA_EVENTS);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_SOC_FUSA_ACTION);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_FUSA_EVENT);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_FUSA_ACTION);
  _FORCE_SET_ENUM(RS2_FRAME_METADATA_SAFETY_CRC32);
  ...
  _FORCE_SET_ENUM(RS2_OPTION_SAFETY_PRESET_ACTIVE_INDEX);
  _FORCE_SET_ENUM(RS2_OPTION_SAFETY_CAMERA_MODE);
  ...
  _FORCE_SET_ENUM(RS2_EXTENSION_SAFETY_SENSOR);
  ...
  _FORCE_SET_ENUM(RS2_SAFETY_CAMERA_MODE_RUN)
  _FORCE_SET_ENUM(RS2_SAFETY_CAMERA_MODE_STANDBY)
  _FORCE_SET_ENUM(RS2_SAFETY_CAMERA_MODE_SERVICE)
  _FORCE_SET_ENUM(RS2_SAFETY_CAMERA_MODE_COUNT)
}
