...
while(! win.shouldWindowClose()) {
  ...
  glfw.draw2x2Streams(
    win.window,
    2, // two channels
    depthRGB?depthRGB.getData():null, 'rgb8', depthRGB?depthRGB.width:0, depthRGB?depthRGB.height:0,
    color?color.getData():null, 'rgb8', color?color.width:0, color?color.height:0,
    null, '', 0, 0,
    null, '', 0, 0);
  win.endPaint();
