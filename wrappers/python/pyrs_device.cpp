...
void init_device(py::module &m) {
    ...
    auto_calibrated_device.def(py::init<rs2::device>(), "device"_a)
        ...
        .def("calibration_config_to_json_string", &rs2::auto_calibrated_device::calibration_config_to_json_string, "Convert calibration config to JSON string", "calibration_config"_a, py::call_guard<py::gil_scoped_release>())
        .def("json_string_to_calibration_config", &rs2::auto_calibrated_device::json_string_to_calibration_config, "Convert JSON string to calibration config", "json_str"_a, py::call_guard<py::gil_scoped_release>());
