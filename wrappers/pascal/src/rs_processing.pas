...
function rs2_create_colorizer(error: pRS2_error): pRS2_processing_block; cdecl;
...
function rs2_create_sync_processing_block(error: pRS2_error)
...
function rs2_create_pointcloud(error: pRS2_error): pRS2_processing_block; cdecl;
  external REALSENSE_DLL;
{
...
function rs2_create_threshold(error: pRS2_error): pRS2_processing_block; cdecl;
  external REALSENSE_DLL;
...
function rs2_create_processing_block_fptr
  (proc: pRS2_frame_processor_callback_ptr; context: pvoid; error: pRS2_error)
  : pRS2_processing_block; cdecl; external REALSENSE_DLL;
{
...
function rs2_processing_block_register_simple_option
  (block: pRS2_processing_block; option: Trs2_option; min: single; max: single;
  step: single; def: single; error: pRS2_error): integer; cdecl;
  external REALSENSE_DLL;
...
procedure rs2_start_processing_fptr(block: pRS2_processing_block;
  on_frame: pRS2_frame_callback_ptr; user: pvoid; error: pRS2_error); cdecl;
  external REALSENSE_DLL;
{
...
procedure rs2_delete_processing_block(block: pRS2_processing_block); cdecl;
  external REALSENSE_DLL;
{
...
function rs2_create_frame_queue(capacity: integer; error: pRS2_error)
  : pRS2_frame_queue; cdecl; external REALSENSE_DLL;
{
  deletes frame queue and releases all frames inside it
  param[in] queue queue to delete
}
procedure rs2_delete_frame_queue(queue: pRS2_frame_queue); cdecl;
  external REALSENSE_DLL;
...
function rs2_frame_queue_size(queue: pRS2_frame_queue; error: pRS2_error)
...
function rs2_try_wait_for_frame(queue: pRS2_frame; timeout_ms: cardinal;
  output_frame: pRS2_frame; error: pRS2_error): integer; cdecl;
  external REALSENSE_DLL;
{
...
function rs2_create_align(align_to: Trs2_stream; error: pRS2_error)
  : pRS2_processing_block; cdecl; external REALSENSE_DLL;
{
...
function rs2_create_decimation_filter_block(error: pRS2_error)
  : pRS2_processing_block; cdecl; external REALSENSE_DLL;
...
function rs2_create_temporal_filter_block(error: pRS2_error)
  : pRS2_processing_block; cdecl; external REALSENSE_DLL;
{
...
function rs2_create_spatial_filter_block(error: pRS2_error)
  : pRS2_processing_block; cdecl; external REALSENSE_DLL;
{
...
function rs2_create_hole_filling_filter_block(error: pRS2_error)
  : pRS2_processing_block; cdecl; external REALSENSE_DLL;
{
...
function rs2_create_rates_printer_block(error: pRS2_error)
  : pRS2_processing_block; cdecl; external REALSENSE_DLL;
{
...
function rs2_create_sequence_id_filter(error: pRS2_error)
  : pRS2_processing_block; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_processing_block_info(const block: pRS2_processing_block;
  info: Trs2_camera_info; error: pRS2_error): PChar; cdecl;
  external REALSENSE_DLL;
{
...
function rs2_is_processing_block_extendable_to(const block
  : pRS2_processing_block; extension_type: Trs2_extension; error: pRS2_error)
  : integer; cdecl; external REALSENSE_DLL;
