...
type
  Trs2_notification_category = (RS2_NOTIFICATION_CATEGORY_FRAMES_TIMEOUT,
...
function rs2_notification_category_to_string
  (category: Trs2_notification_category): PChar; cdecl; external REALSENSE_DLL;

{
  Specifies advanced interfaces (capabilities) objects may implement.
}
type
  Trs2_extension = (RS2_EXTENSION_UNKNOWN, RS2_EXTENSION_DEBUG,
    RS2_EXTENSION_INFO, RS2_EXTENSION_MOTION, RS2_EXTENSION_OPTIONS,
    RS2_EXTENSION_VIDEO, RS2_EXTENSION_ROI, RS2_EXTENSION_DEPTH_SENSOR,
    RS2_EXTENSION_VIDEO_FRAME, RS2_EXTENSION_MOTION_FRAME,
    RS2_EXTENSION_COMPOSITE_FRAME, RS2_EXTENSION_POINTS,
    RS2_EXTENSION_DEPTH_FRAME, RS2_EXTENSION_ADVANCED_MODE,
    RS2_EXTENSION_RECORD, RS2_EXTENSION_VIDEO_PROFILE, RS2_EXTENSION_PLAYBACK,
    RS2_EXTENSION_DEPTH_STEREO_SENSOR, RS2_EXTENSION_DISPARITY_FRAME,
    RS2_EXTENSION_MOTION_PROFILE, RS2_EXTENSION_POSE_FRAME,
    RS2_EXTENSION_POSE_PROFILE, RS2_EXTENSION_TM2,
    RS2_EXTENSION_SOFTWARE_DEVICE, RS2_EXTENSION_SOFTWARE_SENSOR,
    RS2_EXTENSION_DECIMATION_FILTER, RS2_EXTENSION_THRESHOLD_FILTER,
    RS2_EXTENSION_DISPARITY_FILTER, RS2_EXTENSION_SPATIAL_FILTER,
    RS2_EXTENSION_TEMPORAL_FILTER, RS2_EXTENSION_HOLE_FILLING_FILTER,
    RS2_EXTENSION_ZERO_ORDER_FILTER, RS2_EXTENSION_RECOMMENDED_FILTERS,
    RS2_EXTENSION_POSE, RS2_EXTENSION_POSE_SENSOR, RS2_EXTENSION_WHEEL_ODOMETER,
    RS2_EXTENSION_GLOBAL_TIMER, RS2_EXTENSION_UPDATABLE,
    RS2_EXTENSION_UPDATE_DEVICE, RS2_EXTENSION_L500_DEPTH_SENSOR,
    RS2_EXTENSION_TM2_SENSOR, RS2_EXTENSION_AUTO_CALIBRATED_DEVICE,
    RS2_EXTENSION_COLOR_SENSOR, RS2_EXTENSION_MOTION_SENSOR,
    RS2_EXTENSION_FISHEYE_SENSOR, RS2_EXTENSION_DEPTH_HUFFMAN_DECODER,
    RS2_EXTENSION_SERIALIZABLE, RS2_EXTENSION_FW_LOGGER,
    RS2_EXTENSION_AUTO_CALIBRATION_FILTER, RS2_EXTENSION_DEVICE_CALIBRATION,
    RS2_EXTENSION_CALIBRATED_SENSOR, RS2_EXTENSION_HDR_MERGE,
    RS2_EXTENSION_SEQUENCE_ID_FILTER, RS2_EXTENSION_MAX_USABLE_RANGE_SENSOR,
    RS2_EXTENSION_DEBUG_STREAM_SENSOR, RS2_EXTENSION_CALIBRATION_CHANGE_DEVICE,
    RS2_EXTENSION_COUNT);

function rs2_extension_type_to_string(atype: Trs2_extension): PChar; cdecl;
  external REALSENSE_DLL;

function rs2_extension_to_string(atype: Trs2_extension): PChar; cdecl;
  external REALSENSE_DLL;
...
type
  Trs2_distortion = (RS2_DISTORTION_NONE,
...
function rs2_distortion_to_string(distortion: Trs2_distortion): PChar; cdecl;
  external REALSENSE_DLL;
...
type
  Trs2_exception_type = (RS2_EXCEPTION_TYPE_UNKNOWN,
...
type
  Trs2_log_severity = (RS2_LOG_SEVERITY_DEBUG,
...
function rs2_log_severity_to_string(info: Trs2_log_severity): PChar; cdecl;
  external REALSENSE_DLL;
...
function rs2_get_error_message(error: pRS2_error): PChar; cdecl;
  external REALSENSE_DLL;
function rs2_get_failed_function(error: pRS2_error): PChar; cdecl;
  external REALSENSE_DLL;
function rs2_get_failed_args(error: pRS2_error): PChar;
cdecl external REALSENSE_DLL;
procedure rs2_free_error(error: pRS2_error); cdecl; external REALSENSE_DLL;
function rs2_exception_type_to_string(TypeException: pRS2_exception_type)
  : PChar; cdecl; external REALSENSE_DLL;
function rs2_get_librealsense_exception_type(error: pRS2_error)
  : Trs2_exception_type; cdecl; external REALSENSE_DLL;
