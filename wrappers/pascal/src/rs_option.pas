...
type
  Trs2_option = (RS2_OPTION_BACKLIGHT_COMPENSATION,
...
function rs2_option_to_string(option: Trs2_option): PChar; cdecl;
  external REALSENSE_DLL; deprecated;

type
  Trs2_sr300_visual_preset = (RS2_SR300_VISUAL_PRESET_SHORT_RANGE,
...
function rs2_sr300_visual_preset_to_string(preset: Trs2_sr300_visual_preset)
...
type
  Trs2_rs400_visual_preset = (RS2_RS400_VISUAL_PRESET_CUSTOM,
    RS2_RS400_VISUAL_PRESET_DEFAULT, RS2_RS400_VISUAL_PRESET_HAND,
    RS2_RS400_VISUAL_PRESET_HIGH_ACCURACY, RS2_RS400_VISUAL_PRESET_HIGH_DENSITY,
    RS2_RS400_VISUAL_PRESET_MEDIUM_DENSITY,
    RS2_RS400_VISUAL_PRESET_REMOVE_IR_PATTERN, RS2_RS400_VISUAL_PRESET_COUNT
    // *< Number of enumeration values. Not a valid input: intended to be used in for-loops. */
    );

function rs2_rs400_visual_preset_to_string(preset: Trs2_rs400_visual_preset)
  : PChar; cdecl; external REALSENSE_DLL;
...
type
  Trs2_l500_visual_preset = (RS2_L500_VISUAL_PRESET_CUSTOM,
    RS2_L500_VISUAL_PRESET_DEFAULT, RS2_L500_VISUAL_PRESET_NO_AMBIENT,
    RS2_L500_VISUAL_PRESET_LOW_AMBIENT, RS2_L500_VISUAL_PRESET_MAX_RANGE,
    RS2_L500_VISUAL_PRESET_SHORT_RANGE, RS2_L500_VISUAL_PRESET_AUTOMATIC,
    RS2_L500_VISUAL_PRESET_COUNT
    // < Number of enumeration values. Not a valid input: intended to be used in for-loops. */
    );

function rs2_l500_visual_preset_to_string(preset: Trs2_l500_visual_preset)
  : PChar; cdecl; external REALSENSE_DLL;
...
type
  Trs2_sensor_mode = (
    ...
    RS2_SENSOR_MODE_VGA, RS2_SENSOR_MODE_XGA, RS2_SENSOR_MODE_QVGA,
    RS2_SENSOR_MODE_COUNT
    // < Number of enumeration values. Not a valid input: intended to be used in for-loops. */
    );

function rs2_sensor_mode_to_string(preset: Trs2_sensor_mode): PChar; cdecl;
...
type
  Trs2_ambient_light = (RS2_AMBIENT_LIGHT_NO_AMBIENT = 1,
    RS2_AMBIENT_LIGHT_LOW_AMBIENT = 2);

function rs2_ambient_light_to_string(preset: Trs2_ambient_light): PChar; cdecl;
  external REALSENSE_DLL;
...
type
  Trs2_digital_gain = (RS2_DIGITAL_GAIN_AUTO = 0, RS2_DIGITAL_GAIN_HIGH = 1,
    RS2_DIGITAL_GAIN_LOW = 2);

function rs2_digital_gain(preset: Trs2_digital_gain): PChar; cdecl;
  external REALSENSE_DLL;

type
  Trs2_host_perf_mode = (RS2_HOST_PERF_DEFAULT = 0,
...
function rs2_host_perf_mode_to_string(perf: Trs2_host_perf_mode): PChar; cdecl;
  external REALSENSE_DLL;
{
...
function rs2_options_list(const options: pRS2_option; error: pRS2_error)
  : pRS2_options_list; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_option_value_description(const options: pRS2_options;
  option: Trs2_option; Value: single; error: pRS2_error): PChar; cdecl;
  external REALSENSE_DLL;
