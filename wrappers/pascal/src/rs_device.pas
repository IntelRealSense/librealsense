...
function rs2_get_device_count(Info_List: Prs2_device_list;
  var Error: prs2_error): integer; cdecl; external REALSENSE_DLL;
{
...
type
  rs2_calibration_type = (RS2_CALIBRATION_AUTO_DEPTH_TO_RGB,
...
function rs2_calculate_target_z(device: pRS2_device; queue1: prs2_frame_queue;
  queue2: prs2_frame_queue; queue3: prs2_frame_queue; target_width: integer;
  target_height: integer; callback: prs2_update_progress_callback_ptr;
  client_data: pvoid; Error: prs2_error): single; cdecl; external REALSENSE_DLL;
