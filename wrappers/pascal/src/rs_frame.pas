...
type
  Trs2_timestamp_domain = (RS2_TIMESTAMP_DOMAIN_HARDWARE_CLOCK,
...
type
  Trs2_frame_metadata_value = (RS2_FRAME_METADATA_FRAME_COUNTER,
...
function rs2_frame_metadata_to_string(metadata: Trs2_frame_metadata_value)
  : PChar; cdecl; external REALSENSE_DLL;
function rs2_frame_metadata_value_to_string(metadata: Trs2_frame_metadata_value)
  : PChar; external REALSENSE_DLL;
...
function rs2_embedded_frames_count(frame: pRS2_frame; error: pRS2_error)
...
function rs2_get_frame_data_size(const frame: pRS2_frame; error: pRS2_error)
  : integer; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_frame_data(const frame: pRS2_frame; error: pRS2_error): pVoid;
  cdecl; external REALSENSE_DLL;
...
function rs2_get_frame_number(const frame: pRS2_frame; error: pRS2_error)
  : uint64; cdecl; external REALSENSE_DLL;
...
function rs2_get_frame_timestamp(const frame: pRS2_frame; error: pRS2_error)
  : Trs2_time_t; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_frame_metadata(const frame: pRS2_frame;
  frame_metadata: Trs2_frame_metadata_value; error: pRS2_error)
  : Trs2_metadata_type; cdecl; external REALSENSE_DLL;
{
...
function rs2_supports_frame_metadata(const frame: pRS2_frame;
  frame_metadata: Trs2_frame_metadata_value; error: pRS2_error): integer; cdecl;
...
function rs2_get_frame_sensor(const frame: pRS2_frame; error: pRS2_error)
  : prs2_sensor; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_frame_width(const frame: pRS2_frame; error: pRS2_error)
  : integer; cdecl; external REALSENSE_DLL;
...
function rs2_depth_frame_get_units(frame: pRS2_frame; error: pRS2_error)
...
function rs2_get_frame_stride_in_bytes(frame: pRS2_frame; error: pRS2_error)
  : integer; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_frame_bits_per_pixel(frame: pRS2_frame; error: pRS2_error)
  : integer; cdecl; external REALSENSE_DLL;
{
  /**
...
procedure rs2_frame_add_ref(frame: pRS2_frame; error: pRS2_error); cdecl;
  external REALSENSE_DLL;
...
function rs2_get_frame_vertices(frame: pRS2_frame; error: pRS2_error)
  : pRS2_vertex; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_frame_texture_coordinates(frame: pRS2_frame; error: pRS2_error)
  : pRS2_pixel; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_frame_points_count(frame: pRS2_frame; error: pRS2_error)
  : integer; cdecl; external REALSENSE_DLL;
{
...
function rs2_get_frame_stream_profile(frame: pRS2_frame; error: pRS2_error)
...
function rs2_is_frame_extendable_to(frame: pRS2_frame;
  extension_type: Trs2_extension; error: pRS2_error): integer; cdecl;
  external REALSENSE_DLL;
{
...
function rs2_allocate_points(Source: pRS2_source;
  const new_stream: pRS2_stream_profile; original: pRS2_frame;
  error: pRS2_error): pRS2_frame; cdecl; external REALSENSE_DLL;
...
procedure rs2_extract_target_dimensions(frame: pRS2_frame;
  calib_type: Trs2_calib_target_type; target_dims: single;
  dims_size: nativeuint; error: pRS2_error); cdecl; external REALSENSE_DLL;
