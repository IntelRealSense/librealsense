...
type
  Trs2_playback_status = (RS2_PLAYBACK_STATUS_UNKNOWN, // < Unknown state */
...
type
  ...
  rs2_playback_status_changed_callback_ptr = procedure(aTrs2_playback_status
    : Trs2_playback_status); cdecl;
...
function rs2_create_record_device(const device: pRS2_device;
  const FileName: PChar; error: pRS2_error): pRS2_device; cdecl;
...
function rs2_create_record_device_ex(const device: pRS2_device;
  const FileName: PChar; compression_enabled: integer; error: pRS2_error)
...
procedure rs2_record_device_resume(const device: pRS2_device;
  error: pRS2_device); cdecl; external REALSENSE_DLL;
{
...
function rs2_record_device_filename(const device: pRS2_device;
...
function rs2_create_playback_device(const FileName: PChar; error: pRS2_error)
  : pRS2_device; cdecl; external REALSENSE_DLL;
{
...
function rs2_playback_get_duration(const device: pRS2_device;
  error: pRS2_error): uint64;
cdecl external REALSENSE_DLL;
{
...
procedure rs2_playback_seek(const device: pRS2_device; time: int64;
...
function rs2_playback_get_position(const device: pRS2_device; error: pRS2_error)
...
procedure rs2_playback_device_resume(const device: pRS2_device;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
{
...
procedure rs2_playback_device_pause(const device: pRS2_device;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
{
...
function rs2_playback_device_is_real_time(const device: pRS2_device;
  real_time: integer; error: pRS2_error): integer; cdecl;
  external REALSENSE_DLL;
{
