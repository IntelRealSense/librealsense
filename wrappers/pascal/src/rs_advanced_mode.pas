...
procedure rs2_is_enabled(dev: pRS2_device; Enabled: PInteger;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
{
  Sets new values for Depth Control Group, returns 0 if success
}
procedure rs2_set_depth_control(dev: pRS2_device;
  const group: pSTDepthControlGroup; error: pRS2_error); cdecl;
...
procedure rs2_get_rau_support_vector_control(dev: pRS2_device;
  group: pSTRauSupportVectorControl; error: pRS2_error); cdecl;
  external REALSENSE_DLL;
{
...
procedure rs2_set_hdad(dev: pRS2_device; const group: pSTHdad;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
{
...
procedure rs2_set_color_correction(dev: pRS2_device;
  const group: pSTColorCorrection; error: pRS2_error); cdecl;
  external REALSENSE_DLL;
{
...
procedure rs2_set_depth_table(dev: pRS2_device;
  const group: pSTDepthTableControl; error: pRS2_error); cdecl;
  external REALSENSE_DLL;
{
...
procedure rs2_set_ae_control(dev: pRS2_device; const group: pSTAEControl;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
procedure rs2_get_ae_control(dev: pRS2_device; group: pSTAEControl;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
procedure rs2_set_census(dev: pRS2_device; const group: pSTCensusRadius;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
procedure rs2_get_census(dev: pRS2_device; group: pSTCensusRadius;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
procedure rs2_set_amp_factor(dev: pRS2_device; const group: pSTAFactor;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
procedure rs2_get_amp_factor(dev: pRS2_device; group: pSTAFactor;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
