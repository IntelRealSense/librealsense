...
procedure rs2_delete_raw_data(const buffer: pRS2_raw_data_buffer); cdecl;
...
function rs2_get_raw_data(buffer: pRS2_raw_data_buffer; error: pRS2_error)
  : byte; cdecl; external REALSENSE_DLL;
...
function rs2_get_api_version(error: pRS2_error): integer; cdecl;
  external REALSENSE_DLL;

procedure rs2_log_to_console(min_severity: Trs2_log_severity;
  error: pRS2_error); cdecl; external REALSENSE_DLL;

procedure rs2_log_to_file(min_severity: Trs2_log_severity;
  const file_path: PChar; error: pRS2_error); cdecl; external REALSENSE_DLL;
...
function rs2_get_raw_log_message(const msg: pRS2_log_message; error: pRS2_error)
  : PChar; cdecl; external REALSENSE_DLL;

function rs2_get_full_log_message(const msg: pRS2_log_message;
  error: pRS2_error): PChar; cdecl; external REALSENSE_DLL;
{
...
procedure rs2_log(severity: Trs2_log_severity; const message: PChar;
  error: pRS2_error); cdecl; external REALSENSE_DLL;
...
function rs2_depth_frame_get_distance(const frame_ref: pRS2_frame; x: integer;
  y: integer; error: pRS2_error): single; cdecl; external REALSENSE_DLL;
...
function rs2_get_time(error: pRS2_error): Trs2_time_t; cdecl;
  external REALSENSE_DLL;
