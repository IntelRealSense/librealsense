...
public:
    ...
    void add_init_msgs( const topics::raw::device::notification& notification_msg );
    void publish_image( const std::string& stream_name, const uint8_t* data, size_t size );
    void publish_notification( const topics::raw::device::notification& notification_msg );
