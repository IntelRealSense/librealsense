...
#ifndef _FAST_DDS_GENERATED_LIBREALSENSE_DDS_TOPICS_RAW_DEVICE_NOTIFICATIONS_H_
#define _FAST_DDS_GENERATED_LIBREALSENSE_DDS_TOPICS_RAW_DEVICE_NOTIFICATIONS_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(notifications_SOURCE)
#define notifications_DllAPI __declspec( dllexport )
#else
#define notifications_DllAPI __declspec( dllimport )
#endif // notifications_SOURCE
#else
#define notifications_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define notifications_DllAPI
#endif // _WIN32
    ...
    namespace dds {
        namespace topics {
            namespace raw {
                namespace device {
                    /*!
                     * @brief This class represents the structure notifications defined by the user in the IDL file.
                    ...
                    public:
                         ...
                         */
                        eProsima_user_DllExport notifications();
                         ...
                         * @param x Reference to the object librealsense::dds::topics::raw::device::notifications that will be copied.
                         */
                        eProsima_user_DllExport notifications(
                         ...
                         * @param x Reference to the object librealsense::dds::topics::raw::device::notifications that will be copied.
                         */
                        eProsima_user_DllExport notifications& operator =(
                                const notifications& x);
                         ...
                         * @param x librealsense::dds::topics::raw::device::notifications object to compare.
                         */
...
#endif // _FAST_DDS_GENERATED_LIBREALSENSE_DDS_TOPICS_RAW_DEVICE_NOTIFICATIONS_H_