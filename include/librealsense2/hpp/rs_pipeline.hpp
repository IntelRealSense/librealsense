...
namespace rs2
{
    ...
    */
    ...
    public:
        ...
        */
        frameset wait_for_frames(unsigned int timeout_ms = RS_DEFAULT_TIMEOUT) const
        {
            rs2_error* e = nullptr;
        ...
        */
        ...
        bool try_wait_for_frames(frameset* f, unsigned int timeout_ms = RS_DEFAULT_TIMEOUT) const
        {
            if (!f)
            {
                throw std::invalid_argument("null frameset");
