...
typedef enum rs2_format
{
    ...
    RS2_FORMAT_M420           , /**< 24-bit for every pixel: y for each pixel, and u,v data for every four pixels. Internal format, similar to standard NV12 format, but packed in a different order */
