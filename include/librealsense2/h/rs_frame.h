...
typedef enum rs2_frame_metadata_value
{
    ...
    RS2_FRAME_METADATA_FRAME_LAZER_POWER            , /**< Laser power value 0-360. */
    RS2_FRAME_METADATA_FRAME_LAZER_POWER_MODE       , /**< Laser power mode. Zero corresponds to Laser power switched off and one for switched on. */    
    ...
    RS2_FRAME_METADATA_AWB_TEMP                     , /**< Auto white balance temperature Mode indicator. Zero corresponds to AWB switched off. */
    RS2_FRAME_METADATA_BACKLIGHT_COMP               , /**< Color backlight compensation. Zero corresponds to switched off. */
    RS2_FRAME_METADATA_HUE                          , /**< Color image hue. */
    RS2_FRAME_METADATA_GAMMA                        , /**< Color image gamma. */
    RS2_FRAME_METADATA_MANUAL_WB                    , /**< Color image white balance. */
    RS2_FRAME_METADATA_POWER_LINE_FREQUENCY         , /**< Power Line Frequency for anti-flickering Off/50Hz/60Hz/Auto. */
    RS2_FRAME_METADATA_LOW_LIGHT_COMP               , /**< Color lowlight compensation. Zero corresponds to switched off. */
