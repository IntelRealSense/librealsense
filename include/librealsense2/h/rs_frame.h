...
typedef enum rs2_frame_metadata_value
{
    ...
    RS2_FRAME_METADATA_OCCUPANCY_FLOOR_PLANE_EQUATION_A,
    RS2_FRAME_METADATA_OCCUPANCY_FLOOR_PLANE_EQUATION_B,
    RS2_FRAME_METADATA_OCCUPANCY_FLOOR_PLANE_EQUATION_C,
    RS2_FRAME_METADATA_OCCUPANCY_FLOOR_PLANE_EQUATION_D,
    RS2_FRAME_METADATA_OCCUPANCY_SAFETY_PRESET_ID,
