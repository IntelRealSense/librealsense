...
typedef enum rs_option
{
    ...
    RS_OPTION_R200_AUTO_EXPOSURE_TOP_EDGE                     = 43, 
    RS_OPTION_R200_AUTO_EXPOSURE_BOTTOM_EDGE                  = 44, 
    RS_OPTION_R200_AUTO_EXPOSURE_LEFT_EDGE                    = 45, 
    RS_OPTION_R200_AUTO_EXPOSURE_RIGHT_EDGE                   = 46, 
