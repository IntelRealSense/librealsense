...
namespace rs
{
    ...
    enum class stream : int32_t
    {
        ...
        color_aligned_to_depth           = 7,  ///< Synthetic stream containing color data but sharing intrinsic of depth stream
        infrared2_aligned_to_depth       = 8,  ///< Synthetic stream containing second viewpoint infrared data but sharing intrinsic of depth stream
        depth_aligned_to_color           = 9,  ///< Synthetic stream containing depth data but sharing intrinsic of color stream
        depth_aligned_to_rectified_color = 10, ///< Synthetic stream containing depth data but sharing intrinsic of rectified color stream
        depth_aligned_to_infrared2       = 11  ///< Synthetic stream containing depth data but sharing intrinsic of second viewpoint infrared stream
    };
